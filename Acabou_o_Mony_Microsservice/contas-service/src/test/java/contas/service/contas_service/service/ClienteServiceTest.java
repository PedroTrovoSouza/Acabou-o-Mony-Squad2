...
class ClienteServiceTest {
    ...
    @BeforeEach
    void setUp(){
        pessoaFisica = new PessoaFisica(1L, "Fernando", "senha", "fernando@gmail.com",  PerfilEconomico.MEDIO,"12345678901", LocalDate.of(2005,10,02),
                Genero.MASCULINO);
        pessoaJuridica = new PessoaJuridica(1L, "Solutis","solutis@gmail.com", "senha", PerfilEconomico.EMPRESA, "09876543212", LocalDate.of(2005,10,02));
    }
