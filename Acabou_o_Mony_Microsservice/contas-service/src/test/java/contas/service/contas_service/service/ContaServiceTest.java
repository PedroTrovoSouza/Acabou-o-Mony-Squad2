...
class ContaServiceTest {
    ...
    @BeforeEach
    void setUp(){
        pessoaFisica = new PessoaFisica(1L, "Fernando","fernando@gmail.com", "senha",  PerfilEconomico.MEDIO, "12345678901", LocalDate.of(2005,10,02),
                Genero.MASCULINO);
        ...
        pessoaJuridica = new PessoaJuridica(1L, "Solutis", "senha","solutis@gmail.com",  PerfilEconomico.EMPRESA,"09876543212", LocalDate.of(2005,10,02));
